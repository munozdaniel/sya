...
<div class="box-header">
    <h3 class="box-title">Listado de Tipos de Equipo</h3>

    <table width="100%">
        <tr>
            <td align="left">
                {{ link_to("tipoequipo/index", "VOLVER",'class':'btn btn-flat btn-large btn-warning') }}
            </td>
            <td align="right">
                {{ link_to("tipoequipo/new", "CREAR ",'class':'btn btn-flat btn-large btn-danger') }}
            </td>
        </tr>
    </table>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 ">
                        ...
                        <div class="heading">
                            ...
                            <p>Recuerde que el Tipo de Equipo eliminado no podrá ser utilizado nuevamente.</p>
                        </div>
            ...
            <div class="modal-footer">
                ...
                {{ form('tipoequipo/eliminar','method':'POST') }}
                <div  id="cuerpo">
