...
<div class="page-container container">
    ...
    <div class="page-content">
        ...
        <!-- Statistics -->
        <ul class="row stats">
            <li class="col-xs-3"><a href="#" class="btn btn-success">52</a> <span>new pending tasks</span></li>
            <li class="col-xs-3"><a href="#" class="btn btn-info">520</a> <span>pending orders</span></li>
            <li class="col-xs-3"><a href="#" class="btn btn-danger">14</a> <span>new opened tickets</span></li>
